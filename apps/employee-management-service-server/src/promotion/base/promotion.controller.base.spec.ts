...
const CREATE_INPUT = {
  createdAt: new Date(),
  id: "exampleId",
  officeOrder: "exampleOfficeOrder",
  promotionDate: new Date(),
  promotionDetails: "examplePromotionDetails",
  updatedAt: new Date(),
};
const CREATE_RESULT = {
  createdAt: new Date(),
  ...
  test("POST /promotions", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        promotionDate: CREATE_RESULT.promotionDate.toISOString(),
      ...
      .expect([
        {
          ...
          promotionDate: FIND_MANY_RESULT[0].promotionDate.toISOString(),
  ...
  test("GET /promotions/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        promotionDate: FIND_ONE_RESULT.promotionDate.toISOString(),
