...
@InputType()
class PromotionCreateNestedManyWithoutEmployeesInput {
...
export { PromotionCreateNestedManyWithoutEmployeesInput as PromotionCreateNestedManyWithoutEmployeesInput };
